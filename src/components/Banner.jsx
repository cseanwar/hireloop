  ...
  return (
    <div className="relative w-full bg-[#1E1E1E05] text-white overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(circle, #7b8cff 1px, transparent 1px)",
      ...
      {/* ── Star particles ── */}
      {[
        { top: "12%", left: "5%"  }, { top: "8%",  left: "78%" },
        { top: "35%", left: "2%"  }, { top: "28%", left: "93%" },
        { top: "55%", left: "90%" }, { top: "62%", left: "4%"  },
        { top: "20%", left: "50%" }, { top: "70%", left: "65%" },
        { top: "15%", left: "30%" }, { top: "45%", left: "82%" },
      ].map((s, i) => (
        <span
          key={i}
      ...
      {/* ── Content ── */}
      <div className="relative z-10 mx-auto max-w-3xl px-6 pt-20 pb-5 flex flex-col items-center text-center">
        ...
        <div className="mt-12 w-full flex items-center rounded-2xl border border-white/20 bg-[#101010] backdrop-blur-sm px-6 py-2 gap-3">
          ...
          <div className="flex items-center gap-2.5 flex-1 min-w-0">
            <svg className="w-6 h-6 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
