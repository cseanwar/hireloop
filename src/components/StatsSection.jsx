...
export default function StatsSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-black pt-80 text-white">
      {/* Background Globe */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat -top-55 opacity-90"
        style={{
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl bg-linear-to-b from-[#010102] to-[#313131] border border-white/[0.07] p-8 backdrop-blur-xl hover:border-white/15 transition-colors duration-300 cursor-default"
            >
...
//     return (
//         <section className="relative overflow-hidden bg-black pt-140 -top-60 text-white">
