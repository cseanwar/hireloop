...
export default function CompanyProfile({ recruiter, recruiterCompany }) {
  ...
  if (!company?._id && !isEditing) {
    return (
      <div className="relative max-w-3xl mx-auto py-20 flex flex-col items-center text-center">
        {/* Glow */}
        <div className="absolute top-12 w-72 h-72 bg-white/5 blur-[120px] rounded-full" />

        {/* Main Image */}
          <Image
            src="/images/OverlayBlur.png"
        ...
        {/* Description */}
        <p className="max-w-xl text-lg leading-8 text-zinc-400 mb-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-28">
          <Button
            ...
            className="bg-white text-black hover:bg-zinc-200 rounded-xl h-14 px-10 font-medium"
          >
          ...
          <Button
            variant="bordered"
            className="border border-white/10 bg-[#201F20] hover:bg-[#444748] text-white rounded-xl h-14 px-10"
          >
            View FAQ
          </Button>
        </div>
